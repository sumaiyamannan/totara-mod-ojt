...
$string['confirmcheckin'] = 'You are about to save modifications to your local language pack. This will export the customised strings from the translator into you Totara data directory and Totara will start using the modified strings. Press \'Continue\' to proceed with saving.';
