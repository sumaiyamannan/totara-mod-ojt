...
$string['allowfileuploads'] = 'Allow file uploads';
...
$string['ojtname_help'] = 'This is the content of the help tooltip associated with the OJT name field. Markdown syntax is supported.';
$string['ojt'] = 'OJT';
...
$string['topiccomments'] = 'Topic comments';
