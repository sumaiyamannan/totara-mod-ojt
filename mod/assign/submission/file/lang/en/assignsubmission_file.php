...
$string['enabled_help'] = 'If enabled, learners are able to upload one or more files as their submission.';
...
$string['maxfilessubmission_help'] = 'If file submissions are enabled, each learner will be able to upload up to this number of files for their submission.';
$string['maximumsubmissionsize'] = 'Maximum submission size';
$string['maximumsubmissionsize_help'] = 'Files uploaded by learners may be up to this size.';
