...
$string['enabled_help'] = 'If enabled, the trainer will be able to create annotated PDF files when marking the assignments. This allows the trainer to add comments, drawing, and stamps directly on top of the learners work. The annotating is done in the browser and no extra software is required.';
