...
function facetoface_generate_ical($f2f, $session, $method, $user, $dates = null, $canceldates = [], $description = '') {
    ...
    $canceldates = array_combine(array_map($get_id, $canceldates), $canceldates);
 ...
 * @deprecated Deprecated since Totara 9.17 No deprecation warning issued, but the function doesn't work properly.
 *             It's highly encouraged to use facetoface_generate_ical() instead.
 */
