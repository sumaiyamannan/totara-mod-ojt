...
$string['allowassetconflicts_help'] = 'Checking this box will allow an asset to be assigned to 2 or more sessions that are running at the same time.';
...
$string['mincapacity_help'] = 'If the minimum bookings has not been reached by the cut-off point, then the appropriate users will be automatically notified. Users to be notified is determined by role assignments and the configuration setting under Site administration > Seminars > General Settings > Notification recipients';
...
Room:   [session:room]
';
$string['setting:defaultdatetimechangemessagedefault_v9'] = 'Your session has changed:
...
$string['userwillbewaitlisted'] = 'This event is currently full. By clicking the "Join waitlist" button, you will be placed on the event\'s wait-list.';
...
Please note, when selecting <strong>All booked</strong>, notifications will be issued to all booked users, regardless of their attendance status, for events past and present.
