...
Feature: Minimum Seminar bookings
  ...
  Scenario Outline: Confirm notifications are sent out once cutoff has been reached
    ...
    And I <student> see "Event under capacity for: test activity"
    And I log out
    And I log in as "trainer1"
    And I click on "Dashboard" in the totara menu
    And I <trainer> see "Event under capacity for: test activity"
    And I log out
    And I log in as "teacher1"
    And I click on "Dashboard" in the totara menu
    And I <teacher> see "Event under capacity for: test activity"
    And I log out
    And I log in as "creator"
    And I click on "Dashboard" in the totara menu
    And I <creator> see "Event under capacity for: test activity"
    And I log out
    And I log in as "siteman"
    And I click on "Dashboard" in the totara menu
    And I <manager> see "Event under capacity for: test activity"
    And I log out
