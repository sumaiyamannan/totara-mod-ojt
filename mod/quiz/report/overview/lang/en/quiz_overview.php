...
$string['overviewreportgraph'] = 'Overall number of learners achieving grade ranges';
$string['overviewreportgraphgroup'] = 'Number of learners in group \'{$a}\' achieving grade ranges';
