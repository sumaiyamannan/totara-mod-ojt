...
$string['userdata_help'] = 'Grades may be copied and pasted from a spreadsheet into the gradebook. The spreadsheet should have a column containing user identity data (either username, ID number, or email address). Each column for import should have a column header.';
