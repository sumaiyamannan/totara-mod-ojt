...
$string['alwaysshowdefinition'] = 'Show guide definition to learners';
...
$string['descriptionstudents'] = 'Description for Learners';
$string['err_maxscorenotnumeric'] = 'Criterion max score must be numeric';
$string['err_nocomment'] = 'Comment can not be empty';
$string['err_nodescription'] = 'Learner description can not be empty';
...
$string['hidestudentdesc'] = 'Hide learner criterion descriptions';
$string['maxscore'] = 'Maximum mark';
$string['name'] = 'Name';
$string['needregrademessage'] = 'The marking guide definition was changed after this learner had been graded. The learner can not see this marking guide until you check the marking guide and update the grade.';
$string['pluginname'] = 'Marking guide';
$string['previewmarkingguide'] = 'Preview marking guide';
$string['regrademessage1'] = 'You are about to save changes to a marking guide that has already been used for grading. Please indicate if existing grades need to be reviewed. If you set this then the marking guide will be hidden from learners until their item is regraded.';
$string['regrademessage5'] = 'You are about to save significant changes to a marking guide that has already been used for grading. The gradebook value will be unchanged, but the marking guide will be hidden from learners until their item is regraded.';
...
$string['showmarkspercriterionstudents'] = 'Show marks per criterion to learners';
