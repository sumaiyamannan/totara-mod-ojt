...
CALENDAR.prototype = {
    ...
    focus_event: function(e) {
        ...
        } else if (this.calendarimage.hasClass('disabled') !== true &&
            (this.enablecheckbox === null || this.enablecheckbox.get('checked'))
        ) {
            // Must be hidden. If the field is enabled display the pop-up.
            this.claim_calendar();
        }
