...
Y.extend(DRAGDROP, Y.Base, {
    ...
    get_drag_handle: function(title, classname, iconclass, large) {
        ...
        require(['core/templates'], function (templates) {
            templates.renderIcon('arrows', title, iconclass).done(function (icon) {
                dragelement.append(icon);
            });
        });
    ...
    find_element_text: function(n) {
        ...
        var nodes = n.all('[data-movetext="true"]');
        var text = '';
        ...
        // Keep old method for backwards compatablity.
        nodes = n.all('h2, h3, h4, h5, span:not(.actions):not(.menu-action-text), p, div.no-overflow, div.dimmed_text');
    ...
    global_keyboard_drop: function(e) {
        ...
        // Simulate the end sequence. The start adds formatting when using the mouse
