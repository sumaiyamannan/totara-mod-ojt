 ...
 */
  ...
  */
define(['jquery', 'core/config','core/notification', 'core/templates', 'core/flex_icon'], function($, config, notification, templates, flex) {
    ...
    var changePermissions = function(row, roleid, action) {
        ...
        .done(function(data) {
            ...
            try {
                ...
                switch (action) {
                    case 'allow':
                        templatedata.spanclass = 'label label-success allowed';
                        templatedata.linkclass = 'preventlink';
                        templatedata.action = 'prevent';
                        break;
                    case 'prohibit':
                        templatedata.spanclass = 'label label-danger forbidden';
                ...
                flex.getIconData('delete-ns', '', {alt: templatedata.action}).then(function(icon) {
                    templatedata.deleteicon = icon;
                    return templates.render('core/permissionmanager_role', templatedata);
