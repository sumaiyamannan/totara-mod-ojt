...
function unmaskPassword(id) {
    ...
    if (Y.UA.ie == 0 || Y.UA.ie >= 9) {
        ...
        try {
            ...
            if (chb.checked) {
              var newpw = document.createElement('<input type="text" autocomplete="new-password" name="'+pw.name+'">');
            } else {
              var newpw = document.createElement('<input type="password" autocomplete="new-password" name="'+pw.name+'">');
            }
