...
$plugin->version   = 2014052100;       // The current module version (Date: YYYYMMDDXX)
$plugin->requires  = 2013051400;    // Requires this Moodle version
$plugin->component = 'local_bouncechecker'; // Full name of the plugin (used for diagnostics)
$plugin->cron      = 28800;  // 8 hours
