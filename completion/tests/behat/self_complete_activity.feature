...
Feature: User can self complete an activity from within an activity
  ...
  Examples:
    ...
    | External tool | Activity name   | Launch URL      | https://lti-examples.heroku.com/index.html |
  ...
  @_file_upload
  Scenario: Confirm the file activity has self completion available inside itself
    And I log in as "admin"
    And I click on "Find Learning" in the totara menu
    And I click on "Course 1" "link"
    And I click on "Turn editing on" "button"
