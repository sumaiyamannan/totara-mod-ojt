...
class store extends \SimpleSAML\Store {
    ...
    public function set($type, $key, $value, $expire = null) {
        ...
        $record = $DB->get_record('auth_catadmin_kvstore', $find);
        if ($record) {
            $data['id'] = $record->id;
            $DB->update_record('auth_catadmin_kvstore', $data);
        } else {
            $DB->insert_record('auth_catadmin_kvstore', $data);
        }
    }
    ...
    public function delete($type, $key) {
        ...
        $DB->delete_records('auth_catadmin_kvstore', $data);
    }
    ...
    public function delete_expired() {
        global $DB;
        $sql = 'DELETE FROM {auth_catadmin_kvstore}
                 WHERE expire < :now';
