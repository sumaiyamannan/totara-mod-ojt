...
$string['coursesize_desc'] = 'This report only provides approximate values, if a file is used multiple times within a course or in multiple courses the report counts each instance even though Totara only stores one physical version on disk.';
