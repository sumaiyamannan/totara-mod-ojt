...
$string['createuserdescription'] = 'A web services user is required to represent the system controlling Totara.';
...
$string['enablemobilewsoverview'] = 'Go to {$a->manageservicelink} administration page, check the "{$a->enablemobileservice}" setting and Save. Everything will be setup for you and all site\'s users will be able to use the offical Totara app. Current status: {$a->wsmobilestatus}';
...
$string['key'] = 'Key';
$string['keyshelp'] = 'The keys are used to access your Totara account from external applications.';
...
$string['onesystemcontrolling'] = 'Allow an external system to control Totara';
$string['onesystemcontrollingdescription'] = 'The following steps help you to set up the Totara web services to allow an external system to interact with Totara. This includes setting up a token (security key) authentication method.';
...
$string['userasclientsdescription'] = 'The following steps help you to set up the Totara web service for users as clients. These steps also help to set up the recommended token (security keys) authentication method. In this use case, the user will generate their token from the security keys page via their preferences page.';
...
$string['wsclientdoc'] = 'Totara web service client documentation';
