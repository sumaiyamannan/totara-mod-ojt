...
$string['enrolcohort'] = 'Enrol audience';
...
$string['errorenrolcohort'] = 'Error creating audience sync enrolment instance in this course.';
$string['errorenrolcohortusers'] = 'Error enrolling audience members in this course.';
...
$string['expirythreshold_help'] = 'Decide how long before enrolment expiry should users be notified.';
...
$string['participationeffectivelysuspended'] = 'Effectively suspended';
$string['participationeffectivelysuspended_help'] = 'Note: Status is effectively suspended because the enrolment method used for this learner is currently disabled. Re-enable this method to restore active status for all the learners who used it.';
