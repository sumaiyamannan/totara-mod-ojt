...
$string['deleteblockwarning'] = '<p>You are about to delete a block that may appear elsewhere.</p><p>Original block location: {$a->location}<br />Display on page types: {$a->pagetype}</p><p>Are you sure you want to continue?</p>';
