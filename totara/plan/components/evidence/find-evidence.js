...
M.totara_plan_find_evidence = M.totara_plan_find_evidence || {
    ...
    init: function(Y, args){
        ...
        var saveurl = evidenceurl + 'update-evidence.php?sesskey=' + M.config.sesskey + '&planid='+this.config.plan_id+'&component='+this.config.component_name+'&itemid='+this.config.item_id+'&update=';
