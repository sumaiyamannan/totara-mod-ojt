 ...
 * @author Dave Wallace <alastair.munro@totaralms.com>
 * @package totara
 * @subpackage totara_core
 */
M.totara_plan_competency_find_course = M.totara_plan_competency_find_course || {
    ...
    init: function(Y, args){
        ...
        var saveurl = url + 'update-course.php?sesskey='+M.cfg.sesskey+'&planid='+this.config.plan_id+'&competencyid='+this.config.competency_id+'&update=';
