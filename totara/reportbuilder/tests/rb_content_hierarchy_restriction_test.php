...
class totara_rb_content_hierarchy_restrictions_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        foreach ($posusers as $posid => $userlist) {
            ...
            if (!empty($parentid)) {
                $this->set_expected_below($this->hierarchy, "pos", $positions, $posusers, $posid, $parentid);
            }
        }
        ...
        foreach ($orgusers as $orgid => $userlist) {
            ...
            if (!empty($parentid)) {
                $this->set_expected_below($this->hierarchy, 'org', $organisations, $orgusers, (string)$orgid, $parentid);
            }
        }
     ...
     */
    protected function set_expected_below(&$hierarchy, $prefix, $elarray, $elusers, $addid, $curid) {
        $cur = $elarray[$curid];
