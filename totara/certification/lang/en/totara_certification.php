...
$string['error:stateexpired-baselinetimeexpiresnotempty'] = 'Baseline expiry date should be empty when user\' certification has expired.';
...
$string['error:stateexpired-timewindowopensnotempty'] = 'Window open date should be empty when user\' certification has expired.';
